...
def cal():
    ...
    cal_button_bg = '#7132a8'
    num_button_bg = '#6195ed'
    other_button_bg = '#9e9e9e'
    text_fg = '#ffffff'
    button_active_bg = '#c7bbc7'
    ...
    exit = Button(root, text='Quit', fg='white', bg='#9e9e9e', command=quit, height=1, width=7)
